...
SRC = TOPICS / "“一带一路”沿线国家中文教育发展指标体系数据总表_批次2_五国_v3_20260422.xlsx"
V3 = TOPICS / f"“一带一路”沿线国家中文教育发展指标体系数据总表_批次2_五国_v4_{DATE}.xlsx"
LOG_MD = TOPICS / f"bri_batch2_refine_{DATE}.md"
CKPT = ROOT / "output" / "bri_batch2_refine_ckpt.json"
...
async def run():
    ...
    log_md = [f"# 批次 2 精修日志 (v4)", f"时间：{datetime.now():%Y-%m-%d %H:%M}",
